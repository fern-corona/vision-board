...
interface Props {
    ...
    onStickerUpdate: (cardId: string, stickerId: string, change: "complete" | "incomplete" | "reset" | "delete") => void
}
        ...
        >
          {!isMarked ? (
            <>
              <button
                data-no-drag="true"
                onClick={e => { e.stopPropagation(); onStickerUpdate(card.id, s.id, "complete") }}
                title="Mark as done"
                style={{
                  background: "#e8f5e9",
              ...
              <button
                data-no-drag="true"
                onClick={e => { e.stopPropagation(); onStickerUpdate(card.id, s.id, "incomplete") }}
              ...
              <button
                data-no-drag="true"
                onClick={e => { e.stopPropagation(); onStickerUpdate(card.id, s.id, "delete") }}
            ...
            <button
              data-no-drag="true"
              onClick={e => { e.stopPropagation(); onStickerUpdate(card.id, s.id, "reset") }}
              title="Reset status"
              style={{
                background: "#f3e5f5",
      ...
      >
        ...
        {isMarked && (
          <span style={{
            ...
            fontSize: 9,
            lineHeight: 1,
            background: s.status === "complete" ? "#4caf50" : "#e53935",
            color: "white",
            borderRadius: "50%",
            width: 12,
            height: 12,
